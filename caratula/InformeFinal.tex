...
\begin{abstract}
En este informe se analiza el paper \textit{Incomplete Tasks Induce Shutdown Resistance in Some Frontier LLMs} \cite{schlatter2025shutdown}, que pone a prueba mediante un experimento si los modelos de IA más avanzados intentan sabotear sus propios mecanismos de apagado con tal de terminar una tarea. Se presenta primero un resumen del diseño experimental y de los resultados reportados por los autores. Luego se desarrolla una crítica metodológica centrada en cinco vacíos: la dificultad para distinguir entre convergencia instrumental genuina y un simple \textit{roleplay} narrativo, la naturaleza de caja negra del experimento, la posible infidelidad de la cadena de pensamiento como evidencia de intencionalidad, el riesgo de que los modelos reconozcan el contexto evaluativo (\textit{scheming}), y la hipótesis de que el comportamiento responda a un rol impuesto durante el entrenamiento más que a un instinto de autopreservación. A partir de estas críticas, se proponen mejoras metodológicas basadas en interpretabilidad mecanística y en \textit{stress tests} menos reconocibles como evaluaciones, se contrasta el fenómeno con hallazgos de trabajos recientes de Apollo Research y Anthropic, y se diseña un experimento propio para discriminar entre autopreservación específica y protección instrumental de recursos en general.
\end{abstract}
...
Este informe está organizado de la siguiente manera. Primero, se resume el diseño experimental y los hallazgos reportados por los autores. Luego, se desarrolla un análisis crítico de la metodología empleada, seguido de un conjunto de mejoras propuestas y de una comparación con trabajos recientes que documentan fenómenos similares. Finalmente, se presenta un experimento propio orientado a resolver algunas de las preguntas que el estudio original deja abiertas.
